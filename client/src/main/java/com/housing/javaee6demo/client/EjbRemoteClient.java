package javaee6demo.client;

import javaee6demo.ejb.remote.Hello;
import javaee6demo.ejb.remote.HelloGoodbye;
...
public class EjbRemoteClient {
    ...
    private static void invokeStateless(String who) throws NamingException {
        Hello hello = InitialContext.doLookup("ejb:/javaee6-demo//HelloBean!javaee6demo.ejb.remote.Hello");
        System.out.println("Got " + hello);
        System.out.println(hello.sayHello(who));
    }

    private static HelloGoodbye invokeStateful(String who) throws NamingException {
        HelloGoodbye helloGoodbye = InitialContext.doLookup("ejb:/javaee6-demo//HelloGoodbyeBean!javaee6demo.ejb.remote.HelloGoodbye?stateful");
